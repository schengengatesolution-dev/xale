...
**xale** — **Surprise Bag** food-rescue зах зээл (Монгол).

Бизнес (талх, кафе, ресторан, буудал, дэлгүүр) → хэрэглэгч: **ол → захиал → ав**.
...
| `hotel@xale.mn` | Худалдагч | UB Сити зочид буудал |
| `buyer@xale.mn` | Худалдан авагч | Батбаяр |
| `farm@xale.mn` | Худалдан авагч | Гахайн ферм ХХК |

## Онцлог

1. **Landing** — асуудал, ол → захиал → ав, зорилтот хэрэглэгчид, CTA бүртгүүлэх
2. **Auth** — имэйл/нууц үг, Худалдагч эсвэл Худалдан авагч
3. **Худалдагч** — Surprise Bag CRUD (үнэ, retail, авах цонх, тоо, дүүрэг) + захиалга Авсан/Ирээгүй
4. **Худалдан авагч** — Bag discovery + Reserve (апп дотор төлбөргүй)
5. **Seed** — 6 УБ demo Surprise Bag
